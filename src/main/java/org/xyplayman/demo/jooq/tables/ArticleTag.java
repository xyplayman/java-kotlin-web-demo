...
public class ArticleTag extends TableImpl<ArticleTagRecord> {
    ...
    private static final long serialVersionUID = 560783440;
    ...
    /**
     * The column <code>demo.article_tag.id</code>.
     */
    public final TableField<ArticleTagRecord, ULong> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "");
    ...
    @Override
    public Identity<ArticleTagRecord, ULong> getIdentity() {
        return Keys.IDENTITY_ARTICLE_TAG;
    }
